...
# we omit the following code to avoid cluttered code since we use a lot of libraries. Instead, we provide and load the resulting pickle file.
...
mlp = build_MLP(shape=(6,), neurons=64, hidden_layers=3, droprate=.2, learning_rate=1e-4)
